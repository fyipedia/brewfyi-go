...
[![Go Reference](https://pkg.go.dev/badge/github.com/fyipedia/brewfyi-go.svg)](https://pkg.go.dev/github.com/fyipedia/brewfyi-go)
...
`go get github.com/fyipedia/brewfyi-go`
...
func main() {
    ...
    result, err := client.Search("ethiopian-yirgacheffe")
    if err != nil {
        panic(err)
    }
